  ...
  <div class="printing">
    <div>
      <table>
        ...
        <tr>
          <td class="print-name" colspan="2">KNJIGA PRIMLJENOGA ARHIVSKOG GRADIVA (KNJIGA AKVIZICIJA)</td>
        </tr>
        <tr class="noborder">
          <td class="noborder_empty"></td>
        </tr>
        ...
        <tr>
          <td class="noborder">
            </br>Oznaka i naziv fonda ili zbirke kojima je gradivo pripojeno:</br></br>
          </td>
          <td class='border_right'>
