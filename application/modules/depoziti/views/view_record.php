<!-- Depoziti - pregled - 15.03.2017. -->
<form action="<?php echo base_url()."depoziti/print_record";?>" method="post" role="form" id="form" enctype="multipart/form-data" style="padding: 0px 30px" target="_blank">
  <?php if(isset($data->depoziti_id)){?><input type="hidden" name="id" value="<?php echo isset($data->depoziti_id) ?$data->depoziti_id : "";?>"> <?php }?>
    ...
    <div class="form-group">
      <label for="datum_pohrane">Datum pohrane: </label>
      <input type="text" class="form-control" id="datum_pohrane" name="datum_pohrane" value="<?php echo date("d.m.Y.",strtotime($data->datum_pohrane));?>" disabled="">
    </div>
    <div class="form-group">
